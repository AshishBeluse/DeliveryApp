...
// // Get messaging instance once to avoid repeated calls
...
// ) {
//   const messagingInstance = getMessaging();
//   const initial = await messagingInstance.getInitialNotification();
...
export function listenTokenRefresh(onTokenCb: (token: string) => void) {
